...
<body>
  ...
  <?php }} ?>
                ...
                <ul class="navbar-nav align-self-stretch">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="curricular.php"> <i
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-md-flex align-items-center">
                                            <div>
                                                <h5 class="card-subtitle">Apply for Curricular Activities</h5>
                                                <p>(One time fill only)</p>
                                            </div>
                                        </div>
                                        <!-- title -->
                                        <form action="submitcurricular.php" method="POST" class="needs-validation"
                                            novalidate>
                                            ...
                                            <div class="form-group row">
                                                <label for="inputIntimate" class="col-sm-2 col-form-label">Intimate
                                                    Calling</label>
                                                <div class="col-sm-10">
                                                    <select class="custom-select my-1 mr-sm-2" name="intimate"
                                                        id="inputIntimate">
                                                        <option>Yes</option>
                                                        <option>No</option>
                                                    </select>
                                            ...
                                            <div class="form-group row">
                                                <label for="inputInterview" class="col-sm-2 col-form-label">Interview
                                                    Calling</label>
                                                <div class="col-sm-10">
                                                    <select class="custom-select my-1 mr-sm-2" name="interview"
                                                        id="inputInterview">
                                                        <option>Yes</option>
                                                        <option>No</option>
                                                    </select>
                                            ...
                                            <div class="form-group row">
                                                <label for="inputConfirmation"
                                                    class="col-sm-2 col-form-label">Confirmation Calling</label>
                                                <div class="col-sm-10">
                                                    <select class="custom-select my-1 mr-sm-2" name="confirmation"
                                            ...
                                            <div class="form-group row">
                                                <label for="inputMailing"
                                                    class="col-sm-2 col-form-label">Mailing</label>
                                                <div class="col-sm-10">
                                                    <select class="custom-select my-1 mr-sm-2" name="mailing"
                                                        id="inputMailing">
                                                        <option>Yes</option>
                                                        <option>No</option>
                                                    </select>
                                            ...
                                            <div class="form-group row">
                                                <label for="inputDatabase" class="col-sm-2 col-form-label">Database
                                                    Handling</label>
                                                <div class="col-sm-10">
                                                    <select class="custom-select my-1 mr-sm-2" name="database"
                                                        id="inputDatabase">
                                                        <option>Yes</option>
                                                        <option>No</option>
                                                    </select>
                                            ...
                                            <div class="form-group row">
                                                <label for="inputPoster" class="col-sm-2 col-form-label">Poster
                                                    Making</label>
                                                <div class="col-sm-10">
                                                    <select class="custom-select my-1 mr-sm-2" name="poster"
                                                        id="inputPoster">
                                                        <option>Yes</option>
                                                        <option>No</option>
                                                    </select>
                                            ...
                                            <div class="form-group row">
                                                <label for="inputVideo" class="col-sm-2 col-form-label">Video
                                                    Making</label>
                                                <div class="col-sm-10">
                                                    <select class="custom-select my-1 mr-sm-2" name="video"
                                                        id="inputVideo">
                                                        <option>Yes</option>
                                                        <option>No</option>
                                                    </select>
                                            ...
                                            <div class="form-group row">
                                                <label for="inputGraphic" class="col-sm-2 col-form-label">Graphic
                                                    Designing</label>
                                                <div class="col-sm-10">
                                                    <select class="custom-select my-1 mr-sm-2" name="graphic"
                                                        id="inputGraphic">
                                                        <option>Yes</option>
                                                        <option>No</option>
                                                    </select>
                                            ...
                                            <div class="form-group row">
                                                <label for="inputInduction" class="col-sm-2 col-form-label">Induction
                                                    Meeting</label>
                                                <div class="col-sm-10">
                                                    <select class="custom-select my-1 mr-sm-2" name="induction"
                                                        id="inputInduction">
                                                        <option>Yes</option>
                                                        <option>No</option>
                                                    </select>
