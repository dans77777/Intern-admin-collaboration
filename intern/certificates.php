...
<body>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-md-flex align-items-center">
                                            <div>
                                                <h5 class="card-subtitle">Your Certificates</h5>
                                            </div>
                                        </div>
                                        <!-- title -->
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table table-striped bg-light small">
                                            ...
                                            <?php
                                                    ...
                                                    $sql =  "SELECT * FROM certificate WHERE email='{$_SESSION['legitEmail']}' limit $page1,5";
                                                    $data = mysqli_query($conn,$sql);
  ...
  $query = $conn->query("SELECT `image` from `certificate` where email='{$_SESSION['legitEmail']}' ");
  if($query->num_rows > 0){
      while($row = $query->fetch_assoc()){
  ...
  ?>
                                        ...
                                        <nav aria-label="Page navigation example">
                                            ...
                                            <?php 
                                                $sql = "SELECT * FROM certificate WHERE email='{$_SESSION['legitEmail']}'";
                                                $data = mysqli_query($conn,$sql);
                                                if($data){                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
                                                    ...
                                                    for($b=1;$b<=$a;$b++){
                                                        echo '<li class="page-item"><a class="page-link" href="certificates.php?page='.$b.'">'.$b.'</a></li>';        
                                                    }
                                                }
                                                $conn->close();
                                            ?>
