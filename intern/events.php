                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-md-flex align-items-center">
                                            <div>
                                                <h5 class="card-subtitle">Total Events</h5>
                                            </div>
                                        </div>
                                        <!-- title -->
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table table-striped bg-light small">
                                            ...
                                            <?php
                                                ...
                                                $sql = "SELECT * FROM event ORDER BY start DESC limit $page1,5";
                                                $data = mysqli_query($conn,$sql);
                                               // $result = $conn->query($sql) or die($conn->error);
                                                ...
                                                while($row = $data->fetch_assoc()) {
                                                    ?>
                                                     <tr><td class="text-uppercase"><?php echo $row["name"]; ?></td>
                                                    <td><?php echo $row["start"]; ?></td>
                                                    <td ><?php echo  $row["end"]; ?></td>
                                                    <td>  <button class="btn-primary btn text-primary"><a href="../admin/viewposter.php? id=<?php echo $row['id']; ?>" class="text-white">View</a></button></td>
                                               
                                                    <td>  <button class="btn-primary btn text-primary"><a href="./register.php? name=<?php echo $row['name']; ?>" class="text-white">Register</a></button></td>
                                        ...
                                        <nav aria-label="Page navigation example">
                                            ...
                                            <?php 
                                                ...
                                                if($data){
                                                    ...
                                                    for($b=1;$b<=$a;$b++){
                                                        echo '<li class="page-item"><a class="page-link" href="events.php?page='.$b.'">'.$b.'</a></li>';        
                                                    }
                                                }
                                                $conn->close();
                                            ?>
