...
<body>
  ...
  <?php }} ?> <div class="media-body">
                ...
                <ul class="navbar-nav align-self-stretch">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="internextend.php"> <i
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-md-flex align-items-center">
                                            <div>
                                                <h5 class="card-subtitle">Apply for Internship Extension</h5>
                                                <p>(One time only)</p>
                                            </div>
                                        </div>
                                        <!-- title -->
                                        <form action="submitextend.php" method="POST" class="needs-validation"
                                            novalidate>
                                            ...
                                            <div class="form-group row">
                                                <label for="inputExtension" class="col-sm-2 col-form-label">No of
                                                    Days</label>
                                                <div class="col-sm-10">
                                                    <select class="custom-select my-1 mr-sm-2" name="days"
                                                        id="inputExtension">
