                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-md-flex align-items-center">
                                            <div>
                                                <h4 class="card-title">Curricular Activities</h4>
                                                <h5 class="card-subtitle">Interns Details interested in curricular activities</h5>
                                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped bg-light small">
                                            <tr class="table-dark">
                                                ...
                                                <th>Email</th>
                                                <th>Department</th>
                                                <th>Intimation Calling</th>
                                                <th>Interview Calling</th>
                                                <th>Confirmation Calling</th>
                                                <th>Mailing</th>
                                                <th>Database Handling</th>
                                                <th>Poster Making</th>
                                                <th>Video Making</th>
                                                <th>Graphic Designing</th>
                                                <th>Induction Meet</th>
                                                <th>Delete</th>
                                            </tr>
                                            <?php
                                                if($_SESSION['legitDepartment']=='ALL'){
                                                    if(isset($_POST['search'])){
                                                        ...
                                                        $sql = "SELECT * FROM `curricular` where (`id` like '%$searchKey%' 
                                                        OR `name` like '%$searchKey%' OR `email` like '%$searchKey%' OR `department` like '%$searchKey%')
                                                         limit $page1,5";
                                                        
                                                       
                                                    }else{
                                                        $sql = "SELECT * FROM `curricular`  limit $page1,5";
                                                    }
                                                }else{
                                                    if(isset($_POST['search'])){
                                                        $searchKey=$_POST['search'];
                                                        $sql = "SELECT * FROM `curricular` where (`id` like '%$searchKey%' 
                                                        OR `name` like '%$searchKey%' OR `email` like '%$searchKey%' OR `department` like '%$searchKey%')
                                          (AND `department`='{$_SESSION['legitDepartment']}')";
                                                    }else{
                                                        $sql = "SELECT * FROM `curricular` WHERE `department`='{$_SESSION['legitDepartment']}'";
                                                    }
                                                }
                                               ...
                                               <td> <?php echo $res['initimatecall'];  ?> </td>
                                               <td> <?php echo $res['interviewcall'];  ?> </td>
                                               <td> <?php echo $res['confirmcall'];  ?> </td>
                                               <td> <?php echo $res['mailing'];  ?> </td>
                                               <td> <?php echo $res['databasehandle'];  ?> </td>
                                               <td> <?php echo $res['postermake'];  ?> </td>
                                               <td> <?php echo $res['videomake'];  ?> </td>
                                               <td> <?php echo $res['graphicdesign'];  ?> </td>
                                               <td> <?php echo $res['inductionmeet'];  ?> </td>
                                              
                                               
                                             <td>  <button class="btn-danger btn text-primary"><a href="./deletecircular.php? id=<?php echo $res['id']; ?>" class="text-white">Delete</a></button></td>
...
?>
                                        ...
                                        <nav aria-label="Page navigation example">
                                            ...
                                            if(isset($_POST['search'])){
                                                $searchKey=$_POST['search'];
                                                $sql = "SELECT * FROM curricular WHERE name LIKE '%$searchKey%'";
                                            }else{
                                                $sql = "SELECT * FROM curricular";
                                            }
                                                $data = mysqli_query($conn,$sql);
                                                if($data){
                                                    ...
                                                    for($b=1;$b<=$a;$b++){
                                                        echo '<li class="page-item"><a class="page-link" href="viewcurricular.php?page='.$b.'">'.$b.'</a></li>';        
                                                    }
