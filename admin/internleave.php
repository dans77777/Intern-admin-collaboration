                                    ...
                                    <?php
                                        if($_SESSION['legitDepartment']=='ALL'){
                                            if(isset($_POST['search'])){
                                                ...
                                                $sql = "SELECT * FROM `employee_leave`  limit $page1,5";
                                            }
                                        }else{
                                            if(isset($_POST['search'])){
                                                $searchKey=$_POST['search'];
                                                $sql = "SELECT * FROM `employee_leave` where (`id` like '%$searchKey%' 
                                                OR `name` like '%$searchKey%' OR `email` like '%$searchKey%' OR `dept` like '%$searchKey%'  OR `reason` like '%$searchKey%'
                                                OR `end` LIKE '%$searchKey%' OR `start` LIKE '%$searchKey%')  (AND `dept`='{$_SESSION['legitDepartment']}')";
                                            }else{
                                                $sql = "SELECT * FROM `employee_leave` WHERE `dept`='{$_SESSION['legitDepartment']}'";
                                            }
                                        }
                                         ...
                                         <td>  <button class="btn-danger btn text-primary"><a href="./deleteleave.php? id=<?php echo $res['id']; ?>" class="text-white">Delete</a></button></td>
                                        ...
                                        if(isset($_POST['search'])){
                                            ...
                                            $sql = "SELECT * FROM employee_leave WHERE status!='on progress'";
                                                ...
                                                if($data){
                                                    ...
                                                    for($b=1;$b<=$a;$b++){
                                                        echo '<li class="page-item"><a class="page-link" href="internleave.php?page='.$b.'">'.$b.'</a></li>';        
                                                    }
