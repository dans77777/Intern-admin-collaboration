...
if(isset($_POST['update'])){
    ...
    $sql="UPDATE `alogin` SET `name`='$Name',`password`='$HashPassword',`Department`='$Department' WHERE email='$Email'";
  ...
  <?php }} ?>
                ...
                <ul class="navbar-nav align-self-stretch">
                    ...
                    <?php if($_SESSION['legitType']=='superadmin'){?>
                        <li class="nav-item">
                            <a class="nav-link active" href="createsubadmin.php"> <i class="fa fa-home mr-3 text-primary"></i> Create Sub Admin</a>
                        </li>
                    <?php } ?>
                    <li class="nav-item">
                ...
                <div class="container-fluid p-0 px-lg-0 px-md-0">
                    ...
                    <div class="container-fluid px-lg-4">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <form method="POST" action="createadmin.php" class="needs-validation" novalidate>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="email" placeholder="name.cde@gmail.com"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="password" id="inputPassword" name="pass"
                                                required>
                                        </div>
                                        <div class="valid-feedback">
                                            Looks good!
                            ...
                            <div class="col-md-12 table-responsive p-2">
                                <div class="card table-responsive">
                                    <div class="card-body">
                                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                            <h2 class="card-title">Sub Admin Details</h2>
                                        ...
                                        <div>
                                            <table class="table table-striped bg-light small p-2">
                                                ...
                                                if(isset($_POST['search'])){
                                                    ...
                                                    $sql = "SELECT * FROM alogin WHERE name LIKE '%$searchKey%' limit $page1,5";
                                                }else{
                                                    $sql = "SELECT * FROM alogin limit $page1,5";
                                                }
                                              ...
                                              //  $result = $conn->query($sql) or die($conn->error);
                                               ...
                                               // $row = mysqli_fetch_assoc($results);
                                                    ...
                                                    while($row = $data->fetch_assoc()) {
                                                        ...
                                                        <td><a href="deletesubadmin.php?delete='.$row["id"].'" class="btn btn-sm btn-danger btn-block"><i class="fa fa-minus"></i> </a></td> 
                                                        </tr>';
                                                    }
                                                ?>
                                            </table>
                                        ...
                                        <div class="text-center col-lg-12">
                                            ...
                                            if($data){
                                                ...
                                                for($b=1;$b<=$a;$b++){
                                                    echo '<li class="page-item"><a class="page-link" href="createsubadmin.php?page='.$b.'">'.$b.'</a></li>';        
                                                }
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="POST" class="needs-validation" novalidate>     
                        ...
                        <div class="mb-2">
                            <button class="btn btn-success btn-block btn-sm" name="update">Update Admin</button>
                        </div>
                    </form>
                </div>
            </div>
